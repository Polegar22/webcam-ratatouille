...
const CONTROLS = ['up', 'down', 'left', 'right', 'idle'];
...
export function predictClass(classId) {
  game.moveMainCharacter(CONTROLS[classId])
...
idleButton.addEventListener('mousedown', () => handler(4));
idleButton.addEventListener('mouseup', () => mouseDown = false);
